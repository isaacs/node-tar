...
function Entry (header, extended, global) {
  ...
  // this._process() ==> process.nextTick(function() { self._process() })
  this._process = process.nextTick.bind(process, this._process.bind(this))

  this.props = {}
  this._header = new TarHeader(header)
...
, resume: function () {
  ...
  // This is set on the instance such that calling
  // this._process() will call it on nextTick
, _process: function () {
